        ...
        try {
            ...
            for(int i = 0; i < students.size(); i++){
                ...
                for(int j = 0; j < student.getScheduledCourses().size(); j++){
                    ...
                    if(courseId.equals("1") || courseId.equals("7") 
                    	|| courseId.equals("13") || courseId.equals("16")){
                        ...
                        for(int l = 0; l < course.prereqs.size(); l++){
                            for(int k = 0; k < numberOfSemesters; k++){
                                ...
                                rhs.addTerm(k + 1, y[i][courseIndex][k]);
                                lhs.addTerm(k + 1, y[i][prerequisiteIndex][k]);
                            }
                        }
            ...
            for(int j = 0; j < courses.size(); j++){
                for(int k = 0; k < numberOfSemesters; k++){
                    ...
                    for(Semester semester: courses.get(j).getSemestersAvailable()){
                        if(k % Semester.values().length == semester.ordinal()){
