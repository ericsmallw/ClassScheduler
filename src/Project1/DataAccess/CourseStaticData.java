...
public class CourseStaticData {
    ...
    protected static final HashMap<String, String[]> prerequisites = new HashMap<String, String[]>();
    protected static final HashMap<String, Semester[]> courseAvailability = new HashMap<String, Semester[]>();
...
//        courseAvailability.put("18", new Semester[]{Semester.Spring});
        ...
        courseAvailability.put("2", new Semester[]{Semester.Summer});
        courseAvailability.put("3", new Semester[]{Semester.Summer});
        courseAvailability.put("4", new Semester[]{Semester.Summer});
        courseAvailability.put("5", new Semester[]{Semester.Fall});
        courseAvailability.put("6", new Semester[]{Semester.Summer});
        courseAvailability.put("7", new Semester[]{Semester.Fall,Semester.Spring,Semester.Summer});
        courseAvailability.put("8", new Semester[]{Semester.Summer});
        courseAvailability.put("9", new Semester[]{Semester.Summer});
        ...
        courseAvailability.put("12", new Semester[]{Semester.Summer});
        courseAvailability.put("13", new Semester[]{Semester.Summer});
        courseAvailability.put("14", new Semester[]{Semester.Fall});
        courseAvailability.put("15", new Semester[]{Semester.Fall,Semester.Spring,Semester.Summer});
        courseAvailability.put("16", new Semester[]{Semester.Fall});
        courseAvailability.put("17", new Semester[]{Semester.Fall,Semester.Spring,Semester.Summer});
        courseAvailability.put("18", new Semester[]{Semester.Fall});
    }
}
